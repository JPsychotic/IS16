...
namespace GameOfLife.RenderEngine.UI.Elements
{
  class DrawableString
  {
    ...
    public DrawableString(string s, Vector2 textPos, Color col, float scale = 2)
    {
      Scale = scale;
      Location = textPos;
    ...
    public static Vector2 Measure(string s, float scale = 2)
    {
      return new Vector2(s.Length * FontWidth * scale, FontHeight * scale);
    }
  }
}
